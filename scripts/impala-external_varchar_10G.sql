...
stored as textfile
location '/user/cma_creator/tpcds/10G/call_center'
...
row format delimited fields terminated by '|'
stored as textfile
location '/user/cma_creator/tpcds/10G/catalog_page'
tblproperties ('serialization.null.format'='')
;
...
row format delimited fields terminated by '|'
stored as textfile
location '/user/cma_creator/tpcds/10G/catalog_returns'
tblproperties ('serialization.null.format'='')
;
...
row format delimited fields terminated by '|'
stored as textfile
location '/user/cma_creator/tpcds/10G/catalog_sales'
tblproperties ('serialization.null.format'='')
;
...
row format delimited fields terminated by '|'
stored as textfile
location '/user/cma_creator/tpcds/10G/customer'
tblproperties ('serialization.null.format'='')
;
...
row format delimited fields terminated by '|'
stored as textfile
location '/user/cma_creator/tpcds/10G/customer_address'
tblproperties ('serialization.null.format'='')
;
...
row format delimited fields terminated by '|'
stored as textfile
location '/user/cma_creator/tpcds/10G/customer_demographics'
tblproperties ('serialization.null.format'='')
;
...
row format delimited fields terminated by '|'
stored as textfile
location '/user/cma_creator/tpcds/10G/date_dim'
tblproperties ('serialization.null.format'='')
;
...
row format delimited fields terminated by '|'
stored as textfile
location '/user/cma_creator/tpcds/10G/household_demographics'
tblproperties ('serialization.null.format'='')
;
...
row format delimited fields terminated by '|'
stored as textfile
location '/user/cma_creator/tpcds/10G/income_band'
tblproperties ('serialization.null.format'='')
;
...
row format delimited fields terminated by '|'
stored as textfile
location '/user/cma_creator/tpcds/10G/inventory'
tblproperties ('serialization.null.format'='')
;
...
row format delimited fields terminated by '|'
stored as textfile
location '/user/cma_creator/tpcds/10G/item'
tblproperties ('serialization.null.format'='')
;
...
row format delimited fields terminated by '|'
stored as textfile
location '/user/cma_creator/tpcds/10G/promotion'
tblproperties ('serialization.null.format'='')
;
...
row format delimited fields terminated by '|'
stored as textfile
location '/user/cma_creator/tpcds/10G/reason'
tblproperties ('serialization.null.format'='')
;
...
row format delimited fields terminated by '|'
stored as textfile
location '/user/cma_creator/tpcds/10G/ship_mode'
tblproperties ('serialization.null.format'='')
;
...
row format delimited fields terminated by '|'
stored as textfile
location '/user/cma_creator/tpcds/10G/store'
tblproperties ('serialization.null.format'='')
;
...
row format delimited fields terminated by '|'
stored as textfile
location '/user/cma_creator/tpcds/10G/store_returns'
tblproperties ('serialization.null.format'='')
;
...
row format delimited fields terminated by '|'
stored as textfile
location '/user/cma_creator/tpcds/10G/store_sales'
tblproperties ('serialization.null.format'='')
;
...
row format delimited fields terminated by '|'
stored as textfile
location '/user/cma_creator/tpcds/10G/time_dim'
tblproperties ('serialization.null.format'='')
;
...
row format delimited fields terminated by '|'
stored as textfile
location '/user/cma_creator/tpcds/10G/warehouse'
tblproperties ('serialization.null.format'='')
;
...
row format delimited fields terminated by '|'
stored as textfile
location '/user/cma_creator/tpcds/10G/web_page'
tblproperties ('serialization.null.format'='')
;
...
row format delimited fields terminated by '|'
stored as textfile
location '/user/cma_creator/tpcds/10G/web_returns'
tblproperties ('serialization.null.format'='')
;
...
row format delimited fields terminated by '|'
stored as textfile
location '/user/cma_creator/tpcds/10G/web_sales'
tblproperties ('serialization.null.format'='')
;
...
row format delimited fields terminated by '|'
stored as textfile
location '/user/cma_creator/tpcds/10G/web_site'
tblproperties ('serialization.null.format'='')
;
