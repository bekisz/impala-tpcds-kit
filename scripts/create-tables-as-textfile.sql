...
-- * schema name (currently tpcds_text)
-- * location path (currently /tmp/tpc-ds/sf10000)

create schema if not exists tpcds_text;
use tpcds_text;
...
stored as textfile
location '/user/csso_szabolcs.beki/tpcds/data/text/call_center'
...
row format delimited fields terminated by '|'
stored as textfile
location '/user/csso_szabolcs.beki/tpcds/data/text/catalog_page'
tblproperties ('serialization.null.format'='')
;
...
row format delimited fields terminated by '|'
stored as textfile
location '/user/csso_szabolcs.beki/tpcds/data/text/catalog_returns'
tblproperties ('serialization.null.format'='')
;
...
row format delimited fields terminated by '|'
stored as textfile
location '/user/csso_szabolcs.beki/tpcds/data/text/catalog_sales'
tblproperties ('serialization.null.format'='')
;
...
row format delimited fields terminated by '|'
stored as textfile
location '/user/csso_szabolcs.beki/tpcds/data/text/customer'
tblproperties ('serialization.null.format'='')
;
...
row format delimited fields terminated by '|'
stored as textfile
location '/user/csso_szabolcs.beki/tpcds/data/text/customer_address'
tblproperties ('serialization.null.format'='')
;
...
row format delimited fields terminated by '|'
stored as textfile
location '/user/csso_szabolcs.beki/tpcds/data/text/customer_demographics'
tblproperties ('serialization.null.format'='')
;
...
row format delimited fields terminated by '|'
stored as textfile
location '/user/csso_szabolcs.beki/tpcds/data/text/date_dim'
tblproperties ('serialization.null.format'='')
;
...
row format delimited fields terminated by '|'
stored as textfile
location '/user/csso_szabolcs.beki/tpcds/data/text/household_demographics'
tblproperties ('serialization.null.format'='')
;
...
row format delimited fields terminated by '|'
stored as textfile
location '/user/csso_szabolcs.beki/tpcds/data/text/income_band'
tblproperties ('serialization.null.format'='')
;
...
row format delimited fields terminated by '|'
stored as textfile
location '/user/csso_szabolcs.beki/tpcds/data/text/inventory'
tblproperties ('serialization.null.format'='')
;
...
row format delimited fields terminated by '|'
stored as textfile
location '/user/csso_szabolcs.beki/tpcds/data/text/item'
tblproperties ('serialization.null.format'='')
;
...
row format delimited fields terminated by '|'
stored as textfile
location '/user/csso_szabolcs.beki/tpcds/data/text/promotion'
tblproperties ('serialization.null.format'='')
;
...
row format delimited fields terminated by '|'
stored as textfile
location '/user/csso_szabolcs.beki/tpcds/data/text/reason'
tblproperties ('serialization.null.format'='')
;
...
row format delimited fields terminated by '|'
stored as textfile
location '/user/csso_szabolcs.beki/tpcds/data/text/ship_mode'
tblproperties ('serialization.null.format'='')
;
...
row format delimited fields terminated by '|'
stored as textfile
location '/user/csso_szabolcs.beki/tpcds/data/text/store'
tblproperties ('serialization.null.format'='')
;
...
row format delimited fields terminated by '|'
stored as textfile
location '/user/csso_szabolcs.beki/tpcds/data/text/store_returns'
tblproperties ('serialization.null.format'='')
;
...
row format delimited fields terminated by '|'
stored as textfile
location '/user/csso_szabolcs.beki/tpcds/data/text/store_sales'
tblproperties ('serialization.null.format'='')
;
...
row format delimited fields terminated by '|'
stored as textfile
location '/user/csso_szabolcs.beki/tpcds/data/text/time_dim'
tblproperties ('serialization.null.format'='')
;
...
row format delimited fields terminated by '|'
stored as textfile
location '/user/csso_szabolcs.beki/tpcds/data/text/warehouse'
tblproperties ('serialization.null.format'='')
;
...
row format delimited fields terminated by '|'
stored as textfile
location '/user/csso_szabolcs.beki/tpcds/data/text/web_page'
tblproperties ('serialization.null.format'='')
;
...
row format delimited fields terminated by '|'
stored as textfile
location '/user/csso_szabolcs.beki/tpcds/data/text/web_returns'
tblproperties ('serialization.null.format'='')
;
...
row format delimited fields terminated by '|'
stored as textfile
location '/user/csso_szabolcs.beki/tpcds/data/text/web_sales'
tblproperties ('serialization.null.format'='')
;
...
row format delimited fields terminated by '|'
stored as textfile
location '/user/csso_szabolcs.beki/tpcds/data/text/web_site'
tblproperties ('serialization.null.format'='')
;
